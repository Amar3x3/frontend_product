...
export default class HomePage extends Component {
    ...
    componentDidMount(){
        // const token = localStorage.getItem('token');
         axios.get('http://127.0.0.1:8080/homecontent/homedata',{
           headers: {
            ...
            <div className="min-grid-2-home cl1_main-home">
                <div className="col1-home reveal-from-left">
                    <p className="text-home"><span style={{fontSize: "17px", fontWeight: "bold"}}>Welcome to DCE REFRIGERATION Pvt Ltd.</span>  <br/>We provide
                        ...
                        Manufacturing, supplying & commissioning our own
        ...
        <div className="slider1 reveal">
            <div className="content1">
                <div className="container-home overflow-hidden">
                    <h1 className="title-home reveal-from-right">Message From Company</h1>
                    <p className="text-home reveal-from-left">DCE Refrigeration is here to help you succeed with our Passion
                        , Dedication and Years of Experience we will support and help you in every step of the way. Let's 
                        work together to turn our Dreams into Reality!
                    </p>
