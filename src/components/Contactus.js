...
export default class Contactus extends Component {
    constructor(props){
        super(props);
        this.state={
             recipient :'20113032@pvgcoet.ac.in',
             name :'',
             email :'',
             mobile :'',
             message :'',
    ...
    componentDidMount(){
        axios.get('http://127.0.0.1:8080/contactuscontent/getcontactdetails')
      .then((response)=> {
    ...
    axios.post('http://127.0.0.1:8080/contactuscontent/addcontact', body)
    ...
    event.preventDefault();
        ...
        axios.post('http://127.0.0.1:8080/emailcontent/sendemail', body)
            .then(function (response) {
...
{/* <!----------------------------------Map and contact form Start---------------------------------------------------> */}
        <div id="Map_n_contact_form" className="container-contact contact-form-contact" style={{backgroundColor: "aliceblue", padding: "2rem"}}>
            <div className="mega-grid-2-contact">
                <div id="" className="map reveal-from-left">
                    <iframe
                ...
                <div className="form">
                    <form className="form1" id="contact_form">
                        ...
                        <p className="p meg-from-client reveal-from-right" type="Message:"><input type="text" placeholder=""
                                style={{
                                    height: "5rem",
                                    border: "1px #737393 solid"}} name='message' required value={this.state.message} onChange={this.changeMessage}/></p>
